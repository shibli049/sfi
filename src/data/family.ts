...
export const familyData: Person[] = [
    ...
    { id: 'farmor', sv: 'Farmor', en: "Grandmother (Dad's mom)", type: 'female', gen: 1, partners: ['farfar'], group: 'farforaldrar', avatar: 'https://api.dicebear.com/9.x/avataaars/svg?seed=Farmor&mouth=smile&eyes=happy&hairColor=d1d5db&top=bun&accessoriesProbability=0&eyebrows=defaultNatural&facialHairProbability=0' },
    ...
    { id: 'mormor', sv: 'Mormor', en: "Grandmother (Mom's mom)", type: 'female', gen: 1, partners: ['morfar'], group: 'morforaldrar', avatar: 'https://api.dicebear.com/9.x/avataaars/svg?seed=Mormor&mouth=smile&eyes=happy&hairColor=d1d5db&top=bun&accessoriesProbability=0&eyebrows=defaultNatural&facialHairProbability=0' },
    ...
    { id: 'syster', sv: 'Syster', en: 'Sister', type: 'female', gen: 3, parents: ['pappa', 'mamma'], group: 'syskon', avatar: 'https://api.dicebear.com/9.x/avataaars/svg?seed=Sister&mouth=smile&eyes=happy&top=curvy&hairColor=4a312c&accessoriesProbability=0&eyebrows=defaultNatural&facialHairProbability=0' },
